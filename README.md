...
#### - (2021-08-28) Due to a mistake in v0.12.0-beta you will have to install v0.12.2-beta apk manually. Release/FDroid versions are not affected.
...
### [Latest release version (v0.11.5)](https://github.com/K1rakishou/Kuroba-Experimental/releases/tag/v0.11.5-release)
