...
abstract class MediaServiceLinkExtraContentDao {
    ...
    @Query("""
        ...
        AND 
            ${MediaServiceLinkExtraContentEntity.URL_COLUMN_NAME} = :url
    """)
    abstract suspend fun selectByPostUid(postUid: String, url: String): MediaServiceLinkExtraContentEntity?
