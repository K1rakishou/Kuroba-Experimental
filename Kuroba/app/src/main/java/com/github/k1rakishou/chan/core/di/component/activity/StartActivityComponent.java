...
public interface StartActivityComponent {
    ...
    void inject(BookmarksSetGridModeViewWidthController bookmarksSetGridModeViewWidthController);
    ...
    void inject(ReviewCrashLogsController reviewCrashLogsController);
    ...
    void inject(EpoxyBoardSelectionView epoxyBoardSelectionView);
    ...
    void inject(ReviewCrashLogsLayout reviewCrashLogsLayout);
    void inject(ViewFullCrashLogLayout viewFullCrashLogLayout);
