...
import com.github.k1rakishou.chan.features.search.posts.data.CharSequenceMurMur
import com.github.k1rakishou.chan.features.search.posts.data.CurrentQueryInfo
import com.github.k1rakishou.chan.features.search.posts.data.ErrorInfo
import com.github.k1rakishou.chan.features.search.posts.data.SearchParameters
import com.github.k1rakishou.chan.features.search.posts.data.SearchPostInfo
  ...
  private fun searchFailureToErrorText(failure: SearchResult.Failure): String {
    return when (val searchError = failure.searchError) {
      ...
      is SearchError.ParsingError -> {
        "Parsing error: ${searchError.message}"
      }
