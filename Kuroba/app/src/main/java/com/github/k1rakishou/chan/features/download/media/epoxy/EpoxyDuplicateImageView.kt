...
class EpoxyDuplicateImageView  @JvmOverloads constructor(
  ...
  fun setServerImage(serverImage: ServerImage?) {
    ...
    if (serverImage == null) {
      ...
      serverImageInfoContainer.setVisibilityFast(GONE)
    } else {
      serverImageInfoContainer.setVisibilityFast(VISIBLE)
  ...
  fun setLocalImage(localImage: LocalImage?) {
    ...
    if (localImage == null) {
      localImageInfoContainer.setVisibilityFast(GONE)
      localImageName.text = null
    } else {
      localImageInfoContainer.setVisibilityFast(VISIBLE)
  ...
  fun setDupImage(dupImage: DupImage?) {
    ...
    if (dupImage == null) {
      duplicateImageInfoContainer.setVisibilityFast(GONE)
      duplicateImageName.text = null
    } else {
      duplicateImageInfoContainer.setVisibilityFast(VISIBLE)
