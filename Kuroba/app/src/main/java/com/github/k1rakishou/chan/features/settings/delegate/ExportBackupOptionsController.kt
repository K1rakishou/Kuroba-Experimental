...
class ExportBackupOptionsController(
    ...
    KurobaComposeCard(
      ...
      LazyColumn(
        ...
        content = {
          ...
          BuildExportLoggerDatabaseOption()
  ...
  private fun LazyListScope.BuildExportLoggerDatabaseOption() {
    item("export_logger_database") {
      ...
      KurobaComposeCheckbox(
        modifier = Modifier
          .fillMaxWidth()
          .wrapContentHeight(),
        currentlyChecked = exportBackupOptions.exportLogsDatabase,
        onCheckChanged = { isChecked ->
          exportBackupOptions = exportBackupOptions.copy(exportLogsDatabase = isChecked)
        },
        text = stringResource(id = R.string.export_backup_options_export_logger_database_option)
      )
    }
  }
