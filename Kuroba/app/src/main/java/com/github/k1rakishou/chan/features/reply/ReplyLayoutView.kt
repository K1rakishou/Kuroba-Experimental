...
class ReplyLayoutView @JvmOverloads constructor(
  ...
  override fun onReplyLayoutPickFileButtonLongClicked() {
    ...
    replyLayoutViewModel.onRemoteImageSelected(selectedImageUrl)
  }
  ...
  private suspend fun showReplyOptions(chanDescriptor: ChanDescriptor, prevReplyMode: ReplyMode) {
    ...
    val ignoreReplyCooldowns = site?.commonSettings?.ignoreReplyCooldowns
    val lastUsedReplyMode = site?.commonSettings?.lastUsedReplyMode
    val check4chanPostAcknowledgedSetting = site
