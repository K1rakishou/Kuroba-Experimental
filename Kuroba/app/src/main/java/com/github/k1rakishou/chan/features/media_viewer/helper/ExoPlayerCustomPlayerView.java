...
public class ExoPlayerCustomPlayerView extends FrameLayout implements AdViewProvider {
    ...
    @Nullable private ExoPlayerCustomPlayerControlView controller;
    @Nullable private final FrameLayout adOverlayFrameLayout;
    @Nullable private final FrameLayout overlayFrameLayout;

    @Nullable private Player player;
    private boolean useController;
    @Nullable private ExoPlayerCustomPlayerControlView.VisibilityListener controllerVisibilityListener;
    ...
    public ExoPlayerCustomPlayerView(Context context) {
        this(context, /* attrs= */ null);
    }

    public ExoPlayerCustomPlayerView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, /* defStyleAttr= */ 0);
    }

    @SuppressWarnings({"nullness:argument", "nullness:method.invocation"})
    public ExoPlayerCustomPlayerView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int shutterColor = 0;
        int playerLayoutId = R.layout.exo_player_view_custom;
    ...
    public static void switchTargetView(
            Player player, @Nullable ExoPlayerCustomPlayerView oldPlayerView, @Nullable ExoPlayerCustomPlayerView newPlayerView) {
     ...
     * {@link #switchTargetView(Player, ExoPlayerCustomPlayerView, ExoPlayerCustomPlayerView)} rather than this method. If you do
    ...
    public void setControllerVisibilityListener(
            @Nullable ExoPlayerCustomPlayerControlView.VisibilityListener listener) {
        Assertions.checkStateNotNull(controller);
    ...
    private final class ComponentListener
            ...
            OnClickListener,
            ExoPlayerCustomPlayerControlView.VisibilityListener {
        ...
        public void onTracksInfoChanged(TracksInfo tracksInfo) {
            ...
            Player player = Assertions.checkNotNull(getPlayer());
