...
class StreamableMediaServiceExtraInfoFetcher(
  ...
  override fun isEnabled(): Boolean {
    return AppModuleAndroidUtils.shouldLoadForNetworkType(
      kurobaSettings.application.parseStreamableTitlesAndDuration.readBlocking()
    )
  }
  ...
  companion object {
    ...
    private val streamableIcon = BitmapFactory.decodeResource(AppModuleAndroidUtils.res, R.drawable.streamable_icon)
  }
