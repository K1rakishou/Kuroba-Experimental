...
class SoundCloudMediaServiceExtraInfoFetcher(
  ...
  override fun isEnabled(): Boolean {
    return AppModuleAndroidUtils.shouldLoadForNetworkType(
      kurobaSettings.application.parseSoundCloudTitlesAndDuration.readBlocking()
    )
  }
  ...
  companion object {
    ...
    private val soundCloudIcon = BitmapFactory.decodeResource(AppModuleAndroidUtils.res, R.drawable.soundcloud_icon)
  }
}