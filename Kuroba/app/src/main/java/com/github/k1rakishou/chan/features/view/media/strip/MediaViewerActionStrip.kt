...
abstract class MediaViewerActionStrip(
  ...
  fun attach(
    ...
    if (chanDescriptor is ChanDescriptor.ThreadDescriptor) {
      ...
      toolbarPostRepliesButtonContainer.setVisibilityFast(GONE)
    }
  }
  ...
  private fun updateToolbarStateFromViewOptions(
    ...
    val visibility = if (
      mediaViewerOptions.mediaViewerOpenedFromAlbum ||
      chanDescriptor is ChanDescriptor.ICatalogDescriptor
    ) {
      VISIBLE
    } else {
      GONE
