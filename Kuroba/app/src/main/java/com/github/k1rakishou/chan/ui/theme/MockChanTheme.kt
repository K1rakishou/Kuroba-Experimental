...
class MockChanTheme(
  ...
  override val accentColor: Int = 0xff00a0a0L.toInt(),
  override val primaryColor: Int = 0xff282a2eL.toInt(),
  override val secondaryColor: Int = 0xff1d1f21L.toInt(),
  override val errorColor: Int = 0xffff4444L.toInt(),
  override val textPrimaryColor: Int = 0xFFDEDEDEL.toInt(),
  override val textSecondaryColor: Int = 0xFFA0A0A0L.toInt(),
  override val textColorHint: Int = 0xFF707070L.toInt(),
  ...
  override val bookmarkCounterNotWatchingColor: Int = 0xff898989L.toInt(),
  override val bookmarkCounterHasRepliesColor: Int = 0xffff4444L.toInt(),
  override val bookmarkCounterNormalColor: Int = 0xff33B5E5L.toInt(),
) : ChanTheme() {
